...
#if N_ABC_MOTORS > 0
  //#define M3_LIMIT_PIN        GPIO_NUM_22 // Can use the Probe Input for a 4th axes limit switch
#endif
...
// #else
// #define RESET_PIN             GPIO_NUM_16 // or other functions
// #endif

// Define probe switch input pin.
#if PROBE_ENABLE
#define PROBE_PIN             GPIO_NUM_22 // Comment out to use as 4th axis endstop
#endif
